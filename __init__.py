...
try:
    ...
    @PromptServer.instance.routes.post('/chick/api/folder/load')
    async def load_images_from_folder_route(request):
        from .server import chick_server
        return await chick_server.load_images_from_folder(request)
    
    @PromptServer.instance.routes.post('/chick/api/document/metadata')
    async def get_document_metadata_route(request):
        from .server import chick_server
        return await chick_server.get_document_metadata(request)
    
    @PromptServer.instance.routes.post('/chick/api/document/content')
    async def get_document_content_route(request):
        from .server import chick_server
        return await chick_server.get_document_content(request)
